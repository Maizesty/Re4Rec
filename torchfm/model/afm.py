...
from layer import FeaturesEmbedding, FeaturesLinear, AttentionalFactorizationMachine
...
class AttentionalFactorizationMachineModel(torch.nn.Module):
    ...
    def __init__(self, field_dims, embed_dim, attn_size, dropouts):
        ...
        self.afm = AttentionalFactorizationMachine(embed_dim, attn_size, dropouts,self.num_fields)
