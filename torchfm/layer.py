...
class FeaturesLinear(torch.nn.Module):
    ...
    def __init__(self, field_dims, output_dim=1):
        ...
        self.offsets = torch.nn.Parameter(torch.as_tensor(np.array((0, *np.cumsum(field_dims)[:-1]), dtype=np.int64)),False)
...
class AttentionalFactorizationMachine(torch.nn.Module):
    ...
    def __init__(self, embed_dim, attn_size, dropouts,num_fields):
        super().__init__()
